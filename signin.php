    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex">
        <div class="w-96 mr-6">
            ...
            <form action="signin_process.php" method="post">
                ...
                <a href="signup.php" class="w-full p-2 bg-yellow-500 text-gray-800 rounded hover:bg-yellow-600 text-center block mb-4">Sign Up</a>
                <a href="index.php" class="w-full p-2 bg-yellow-500 text-gray-800 rounded hover:bg-yellow-600 text-center block">Back to Home</a>
            </form>
        </div>
        <div class="max-w-md">
