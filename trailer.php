...
<body>
    <main id="container" class="bg-stone-900 text-white">
        ...
        if ($omdbData['Response'] === "True") {
            ...
            $trailerEmbed = $trailer ? "<iframe class='rounded-xl' width='760' height='386' src='https://www.youtube.com/embed/{$trailer['key']}' frameborder='0' allowfullscreen></iframe>" : "<p>No trailer available.</p>";
                    ...
                    <div class='flex flex-col gap-2'>
                        ...
                        <div>
                            <span class='flex gap-2'>
                                Metascore:
                                <p class='" . ($omdbData['Metascore'] <= 50 ? 'bg-red-400' : 'bg-green-400') . " px-1 rounded'>{$omdbData['Metascore']}</p>
                            </span>
                        </div>
                        <div>
